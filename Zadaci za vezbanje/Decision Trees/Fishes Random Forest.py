...
if __name__ == "__main__":
    ...
    new_new_sample = []
    for el in new_sample:
        el = int(el)
        new_new_sample.append(el)
    new_sample = new_new_sample
    ...
    classifier = RandomForestClassifier(n_estimators=trees, criterion=criteria, random_state=0)

    classifier.fit(train_x,train_y)

    print("Accuracy:",accuracy_score(test_y, classifier.predict(test_x)))
    print(classifier.predict([new_sample])[0])
