...
if __name__ == '__main__':
    ...
    dataset = new_dataset
    train_set,test_set = dataset[:int(len(dataset)*0.85)], dataset[int(len(dataset)*0.85):]
    ...
    print(int(classifier.predict([new_new_sample])[0]))
    print(classifier.predict_proba([new_new_sample]))